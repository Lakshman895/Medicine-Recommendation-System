...
class ModelTrainer:
    ...
    def creating_directories(self):
        try:
            ...
            logging.info(f'Directory created successfully at {self.config.model_dir}')
            
            create_directories(self.root_dir/self.config.disease_list_path)
            logging.info(f'Directory created successfully at {self.config.disease_list_path}')
            
        except Exception as e:
            raise CustomException(e,sys)
        
    def loading_data(self):
        """Importing the data train data"""
    ...
    def model_trainer(self):
        ...
        try:
            ...
            logging.info(f'Trained model saved successfully at file : {model_path}')
